...
resolved, the TripJack match. **Open full debug panel →** takes you to
`localhost:8765` for the live pricing table, room→rate-plan mapping, and
the Prebook (Review) button.
